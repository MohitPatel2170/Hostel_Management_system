...
<div class="main">
    ...
    <div class="register">
    <a href="admindashboard.jsp"><button type="submit" id="submit" class="mybutto">Go back</button></a>
        ...
        <form id="register" action="update.jsp" method="post">
            ...
            <br><br>
             <label>Room Number: </label><%=rs.getString("roomallot")%>
            <br><br><br>
            ...
            <br><br><br>
             ...
             <button type="submit" id="submit" class="mybutton" name="admin" value="admin">Update</button>
            <br><br>
            <%}%>
            </form>
