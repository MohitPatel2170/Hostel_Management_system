...
<body>
	<table class="table table-success table-striped">
		...
		String qry = "select * from student where ROOMALLOT is null";
		...
		<tr>
			...
			<td><a href="roomno.jsp?sic=<%=rs.getString("sic")%>&fname=<%=rs.getString("fname")%>">Room Number</a>
		</tr>
