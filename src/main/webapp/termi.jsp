...
<title>Termination Student Request</title>
<link
...
<body>
	<table class="table table-success table-striped">
		<h1> Student Termination Request</h1>
		<thead>
			<th>Sic</th>
			<th>Name</th>
			<th>year</th>
		...
		String qry = "select * from student where termi='Yes'";
		...
		<tr>
			...
			<td><a href="adm_std_profile.jsp?sic=<%=rs.getString("sic")%>">Detail</a>
			<td><a href="delete.jsp?sic=<%=rs.getString("sic")%>">Delete</a>
		</tr>
